...
import { EnhancedProjectCard } from "@/components/project-card";
          ...
          {DATA.work.map((work, index) => (
            ...
            >
              <ResumeCard
                ...
                isExpanded={expandedWorkIndex === index}
                onToggleExpand={() => {
                  setExpandedWorkIndex(prevIndex => prevIndex === index ? null : index);
                }}
              />
            </BlurFade>
          ))}
          ...
          {DATA.education.map((education, id) => (
            ...
            >
              <EducationCard
                ...
                grade={"grade" in education ? education.grade : undefined}
              />
            </BlurFade>
          ))}
        </div>
